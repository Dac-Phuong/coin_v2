        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                ...
                <div class="card-header mt-2 d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ __('Add New Coin') }}</h4>
                </div>
                <!--end::Modal title-->
            ...
            <div class="modal-body mb-3">
                <!--begin::Form-->
                <form id="kt_modal_add_coin" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="mb-4">
                        <div>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="any" id="basic-icon-default-email" name="coin_price"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="any" id="basic-icon-default-email" name="coin_fee"
                                    class="form-control">
                                @error('coin_fee')
                                    <span class="error text-danger fs-7">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="any" id="basic-icon-default-email" name="min_withdraw"
                                    class="form-control">
                                @error('min_withdraw')
                                    <span class="error text-danger fs-7">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="any" id="basic-icon-default-email" name="coin_decimal"
                                    class="form-control" value="2" placeholder="4">
                                @error('coin_decimal')
                                    <span class="error text-danger fs-7">{{ $message }}</span>
                                @enderror
                            </div>
                                    ...
                                    @if (isset($network))
                                        @foreach ($network as $item)
                                            <div class="form-check me-3 mb-1">
                                                <input class="form-check-input" name="network_id[]" type="checkbox"
                                                    value="{{ $item->id }}" id="network-{{ $item->id }}">
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" id="btn-add-coin">
...
@push('scripts')
    <script>
        $("#btn-add-coin").click(function(e) {
            e.preventDefault();
            let formData = new FormData($("#kt_modal_add_coin")[0]);
            formData.append("_token", "{{ csrf_token() }}");
            $.ajax({
                url: "{{ route('coin.create') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
