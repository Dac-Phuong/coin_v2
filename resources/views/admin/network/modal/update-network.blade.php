    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mb-3">
                <!--begin::Form-->
                <form id="kt_modal_update_network" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="mb-4">
                        <div>
                            ...
                            <textarea class="form-control" placeholder="" name="description" id="exampleFormControlTextarea1"
                                rows="10"></textarea>
                            @error('description')
                                <span class="error text-danger fs-7">{{ $message }}</span>
                            @enderror
...
@push('scripts')
    <script>
        $("#btn-update").click(function(e) {
            e.preventDefault();
            let formData = new FormData($("#kt_modal_update_network")[0]);
            formData.append("_token", "{{ csrf_token() }}");
            $.ajax({
                url: "{{ route('network.update') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
