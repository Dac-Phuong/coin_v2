        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                ...
                <div class="card-header mt-2 d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ __('Add/Edit withdrawal fees') }}</h4>
                </div>
                <!--end::Modal title-->
            ...
            <div class="modal-body mb-3">
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default">{{ __('Withdrawal fees') }}
                                    ($)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" id="basic-icon-default" wire:model.defer="amount_money"
                                        class="form-control" placeholder="{{ __('Enter the Withdrawal fees') }}"
